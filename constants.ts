...
export const INITIAL_PACKING_LIST_TEMPLATE: PackingCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'c2', label: '保暖外套 (富士山冷)', checked: false },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 't4', label: '個人藥品', checked: false },
    ]
  }
];
...
export const INITIAL_EXPENSES: ExpenseItem[] = [
  { id: '1', title: 'Suica 加值', amount: 5000, currency: 'JPY', category: '交通', payerId: 'u1', type: 'SHARED', date: '2024-04-01' },
  { id: '2', title: '燒肉晚餐', amount: 12000, currency: 'JPY', category: '餐飲', payerId: 'u2', type: 'SHARED', date: '2024-04-01' },
  { id: '3', title: '超商零食 (自己吃)', amount: 850, currency: 'JPY', category: '餐飲', payerId: 'u1', ownerId: 'u1', type: 'PERSONAL', date: '2024-04-01' },
];
